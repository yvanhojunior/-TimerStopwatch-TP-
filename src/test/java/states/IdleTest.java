...
class IdleTest {
	...
	@Test
	@DisplayName("Test du singleton du minuteur qui démarre correctement")
	...
	@Test
	@DisplayName("Test de l'événement 'up' sans transition (reste dans l'état IdleTimer)")
	...
	@Test
	@DisplayName("Test de l'événement 'up' avec transition vers l'état ActiveTimer")
	...
	@Test
	@DisplayName("Test de l'événement 'right' qui amène à l'état SetTimer")
	void testRight() {
